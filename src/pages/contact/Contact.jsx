                ...
                <div className="container">
                    <div className="contact-content">
                        <div className="row">
                                                ...
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        <select
                                                            ...
                                                            onChange={handleChange}
                                                        >
                                                            <option value="">Selecione uns dos Serviços</option>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        ...
                                                        {errors.mensagem && (
                                                            <div className="error-text">{errors.mensagem}</div>
                                                        )}
                                                    </div>
                            ...
                            </div>					<div className="col-md-offset-1 col-md-5 col-sm-6">
                                <div className="single-contact-box">
                                    ...
                                    <div className="hm-foot-icon">
                                        <ul>
                                            <li><a href="https://web.facebook.com/ejdeveloper" target="_blank"><i className="fa fa-facebook"></i></a></li>
                                            <li><a href="https://github.com/ernestojustino9" target="_blank"><i className="fa fa-github"></i></a></li>
                                            <li><a href="https://www.linkedin.com/in/ernesto-justino-6702091a0/" target="_blank"><i className="fa fa-linkedin"></i></a></li>
